...
// Timeline dot color based on action
...
export default function OrderDetailPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      {/* Order items table (if multiple items) */}
                  ...
                  <TableRow key={item.id}>
                    ...
                    <TableCell>
                      <Badge
                        variant="secondary"
                        className={
                          PRODUCTION_STATUS_COLOR[item.productionStatus]
                        }
                      >
